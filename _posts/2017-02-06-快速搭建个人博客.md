---
layout:     post
title:      利用Github搭建自己的博客网站
subtitle:   个人博客网站搭建完全教程 
date:       2017-11-19
author:     Yuan
...
> 
> [我的的博客](http://sunyuan.online)

# 前言
想搭建一个个人博客很久了，期间也通过Hexo+GithubPages做过一个，但是一直对界面风格不太满意，弄好之后就搁置下来了。直到在简书上看到[qiubaiying的博客搭建教程](http://www.jianshu.com/p/e68fba58f75c#Rename)，说的很详细，界面风格也是我喜欢的那种，所以就决定在折腾一波，经过一下午的努力，完成了大部分内容，就想着把过程记录下来，作为个人博客的第一篇文章，[qiubaiying](https://github.com/qiubaiying)是在Mac系统上搭建的其实大同小异，我就在他的文章基础上延伸出一个Windows版本，大部分内容都差不多，我的主要目的是想感受下这个过程，希望看原文的同学可以通过上面的链接查看，本教程作为个人博客[Yuan Blog](http://sunyuan.online)的一个记录，如果能给看到这篇文章的同学一点帮助更好。

[![](https://github.com/sunyuan1993/sunyuan1993.github.io/blob/master/img/2017-11-19--01-bg.png)](http://sunyuan1993.github.io/)
